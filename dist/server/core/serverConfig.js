...
function baseConfig(app) {
  ...
  (0, _koaMount2.default)((0, _koaStatic2.default)(_config2.default.get('paths.static'))), (0, _koaMount2.default)('/dist', (0, _koaStatic2.default)(_config2.default.get('paths.dist.server')))));
}
